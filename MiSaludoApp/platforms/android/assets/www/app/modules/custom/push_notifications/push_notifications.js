...
var GCM_SENDER_ID = "421685014301";
/**
...
function push_notifications_register() {
  ...
  //if (device.platform == 'android' || device.platform == 'Android') {
    pushNotification.register(
    		push_notifications_successHandler, 
    		push_notifications_errorHandler, {
...
function push_notifications_register_device_token(token) {
  ...
  if (push_token === null || push_token != token) {
    var data = {
      'token': token,
      'type': push_notifications_platform_token("android"),/*device.platform*/
    };
