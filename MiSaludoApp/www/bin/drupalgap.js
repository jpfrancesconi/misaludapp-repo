  ...
  try {
    ...
    if (!drupalgap.online) {
      ...
      return;
    	...
    	var cordova =  window.plugins.cordova;
...
function system_dashboard_page() {
  try {
    var content = {};
    content.welcome = {
      markup: '<h2 style="text-align: center;">Bienvenidos a MiSalud App</h2>' +
        '<p style="text-align: center;">' +
          'La aplicaci&oacute;n del Ministerio de Salud de Entre R&iacute;os!' +
        '</p>'
    };
    if (drupalgap.settings.logo) {
      content.logo = {
    ...
    content.support = {
      theme: 'button_link',
      text: 'Web del Ministerio',
      path: 'http://desarrollosocial.entrerios.gov.ar/',
...
function successHandler(result) { console.log('Success: '+ result); } 
